...
final class Bundled_Plugins {
	...
	public function __construct() {
		...
		$llar_plugin_is_active   = is_plugin_active( 'limit-login-attempts-reloaded/limit-login-attempts-reloaded.php' );
		$sucuri_plugin_is_active = is_plugin_active( 'sucuri-scanner/sucuri.php' );

		$bundled_plugins = [
			'limit-login-attempts-reloaded/limit-login-attempts-reloaded.php' => ( ! $llar_plugin_is_active && ! $sucuri_plugin_is_active ),
